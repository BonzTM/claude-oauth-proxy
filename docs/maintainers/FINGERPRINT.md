...
**What it is:** The Claude Code product version (e.g. `2.1.87`).

**Where it's used:**
- Billing header: `cc_version=2.1.87.{turn}`
...
```
x-anthropic-billing-header: cc_version=2.1.87.{turn}; cc_entrypoint=cli; cch=00000;
```
