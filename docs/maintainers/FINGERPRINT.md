...
**What it is:** The Claude Code product version (e.g. `2.1.89`).

**Where it's used:**
- Billing header: `cc_version=2.1.89.{turn}`
...
```
x-anthropic-billing-header: cc_version=2.1.89.{turn}; cc_entrypoint=cli; cch=00000;
```
