...
**What it is:** The Claude Code product version (e.g. `2.1.90`).

**Where it's used:**
- Billing header: `cc_version=2.1.90.{turn}`
- User-Agent: `claude-cli/2.1.90 (external, cli)`

**How to find it:**
```bash
claude --version
# Output: 2.1.90 (Claude Code)
```
...
```
x-anthropic-billing-header: cc_version=2.1.90.{turn}; cc_entrypoint=cli; cch=00000;
```
