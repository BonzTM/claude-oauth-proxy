...
| `CLAUDE_OAUTH_PROXY_CC_VERSION` | `2.1.90` | Claude Code version for billing header and User-Agent |
| `CLAUDE_OAUTH_PROXY_CC_USER_AGENT` | `claude-cli/2.1.90 (external, cli)` | User-Agent header sent upstream |
